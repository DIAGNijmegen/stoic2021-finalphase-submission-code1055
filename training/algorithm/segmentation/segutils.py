...
def load_model(model, model_ema, optimizer):
    #load model like
    savepath = '/data/ssd1/kienzlda/covidsegmentation_logs/checkpoints/unet_onlySupervised_unbalancedLoss_2022-02-10_17-10-46/checkpoint_20.tar'
    identifier = 'unet_onlySupervised_unbalancedLoss_2022-02-10_17-10-46_resumed'
    #identifier = 'test'
