...
from segmentation.data.transforms3D import ToTensor3D, Normalize3D, get_transform, elastic_deform_robin
from segmentation.data.transforms3D import Compose as My_Compose
from segmentation.segconfig.segconfig import BaseConfig
from segmentation.segconfig.segmodelconfig import get_model
import matplotlib.pyplot as plt
from torchvision.transforms import Compose
import csv

def get_unsupervised(idx, transform=None):
    path = '/data/ssd1/kienzlda/data_covidsegmentation/resized/unsupervised'
    ...
    metadatapath = '/data/ssd1/kienzlda/data_stoic/metadata/reference.csv'
...
def get_supervised(idx, transform=None, target_transform=None):
    #path = '/data/ssd1/kienzlda/data_covidsegmentation/resized/Train'
    path = '/data/ssd1/kienzlda/data_stoic/segmentation/resized/Train/'
    filenamelist = []
    dataname_old = None
...
def main():
    model = load_model(savepath='/data/ssd1/kienzlda/stoic_logs/segmentation/checkpoints/segmentation_convnext_onlySupervised_dicece_2022-02-24_13-37-50/checkpoint_30.tar')
    #model = load_model(savepath='/data/ssd1/kienzlda/stoic_logs/segmentation/checkpoints/segmentation_convnext_MeanTeacher_withoutAugmentation_dicece_2022-02-24_13-39-42/checkpoint_30.tar')
    #model = load_model(savepath='/data/ssd1/kienzlda/stoic_logs/segmentation/checkpoints/segmentation_convnext_onlySupervised_dicece_withoutNormalization_2022-02-25_16-01-03/checkpoint_30.tar')
    index = 42
    supslice = 50
