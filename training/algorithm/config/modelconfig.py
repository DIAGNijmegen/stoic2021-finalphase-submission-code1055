import torch
from models.hypernet import HyperConvNeXt3dSTOIC
from models.slice2d import Slice2DModel
from models.resnet import ResNet
from models.convnext import ConvNeXt3dSTOIC
from models.testmodel import Testmodel
from models.uniformer import UniFormer3DSTOIC
...
class TestmodelConfig:
    def __init__(self):
        self.loss_fn = "bce_inf_sev"
        self.dropout = 0.3
        # TODO: I have no idea what this model needs as optim and lr so copied from config.py  --lorenjul
        self.optim_name = "adam"
        self.learning_rate = 1e-5
        self.pos_weight = 3.0  # None
